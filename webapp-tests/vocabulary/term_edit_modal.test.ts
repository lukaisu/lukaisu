...
vi.mock('../../webapp/js/modules/vocabulary/api/terms_api', () => ({
  TermsApi: {
    getForEdit: vi.fn(),
    createFull: vi.fn(),
    updateFull: vi.fn(),
...
vi.mock('../../webapp/js/shared/utils/html_utils', () => ({
  escapeHtml: vi.fn((str: string) => str),
}));

import { openTermEditModal } from '../../webapp/js/modules/vocabulary/components/term_edit_modal';
import { openModal, closeModal } from '../../webapp/js/shared/components/modal';
import { TermsApi } from '../../webapp/js/modules/vocabulary/api/terms_api';
import { escapeHtml } from '../../webapp/js/shared/utils/html_utils';
