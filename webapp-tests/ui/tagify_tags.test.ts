...
} from '../../webapp/js/shared/components/tagify_tags';
...
vi.mock('../../webapp/js/shared/forms/form_validation', () => ({
  containsCharacterOutsideBasicMultilingualPlane: vi.fn().mockReturnValue(false)
}));

import Tagify from '@yaireo/tagify';
import { containsCharacterOutsideBasicMultilingualPlane } from '../../webapp/js/shared/forms/form_validation';
