...
import { initLanguageConfig, resetLanguageConfig } from '../../webapp/js/modules/language/stores/language_config';

// Dynamic import to reset module state
async function importNativeTooltip() {
  vi.resetModules();
  return await import('../../webapp/js/shared/components/native_tooltip');
}
