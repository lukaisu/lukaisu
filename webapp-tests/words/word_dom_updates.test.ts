...
} from '../../webapp/js/modules/vocabulary/services/word_dom_updates';

// Mock dependencies
vi.mock('../../webapp/js/modules/vocabulary/services/word_status', () => ({
...
import { resetSettingsConfig } from '../../webapp/js/shared/utils/settings_config';
...
describe('word_dom_updates.ts', () => {
  ...
  describe('completeWordOperation', () => {
    it('updates learn status and cleans up frames', async () => {
      const { cleanupRightFrames } = await import('../../webapp/js/modules/text/pages/reading/frame_management');
