...
vi.mock('../../webapp/js/shared/forms/unloadformcheck', () => ({
  lukaisuFormCheck: {
    resetDirty: vi.fn()
  }
}));

vi.mock('../../webapp/js/modules/text/pages/reading/frame_management', () => ({
  showRightFramesPanel: vi.fn(),
  hideRightFrames: vi.fn(),
  loadModalFrame: vi.fn()
}));

vi.mock('../../webapp/js/shared/utils/ui_utilities', () => ({
  showAllwordsClick: vi.fn()
}));

vi.mock('../../webapp/js/shared/utils/user_interactions', () => ({
  quickMenuRedirection: vi.fn()
}));

vi.mock('../../webapp/js/modules/vocabulary/services/translation_api', () => ({
  deleteTranslation: vi.fn(),
  addTranslation: vi.fn()
}));

vi.mock('../../webapp/js/modules/vocabulary/services/term_operations', () => ({
  changeTableTestStatus: vi.fn()
}));

vi.mock('../../webapp/js/shared/components/modal', () => ({
  showExportTemplateHelp: vi.fn()
}));

vi.mock('../../webapp/js/modules/vocabulary/services/word_dom_updates', () => ({
...
} from '../../webapp/js/shared/utils/simple_interactions';
import { lukaisuFormCheck } from '../../webapp/js/shared/forms/unloadformcheck';
import { showAllwordsClick } from '../../webapp/js/shared/utils/ui_utilities';
import { quickMenuRedirection } from '../../webapp/js/shared/utils/user_interactions';
import { deleteTranslation, addTranslation } from '../../webapp/js/modules/vocabulary/services/translation_api';
import { changeTableTestStatus } from '../../webapp/js/modules/vocabulary/services/term_operations';
import { showExportTemplateHelp } from '../../webapp/js/shared/components/modal';
import { markWordWellKnownInDOM, markWordIgnoredInDOM } from '../../webapp/js/modules/vocabulary/services/word_dom_updates';
