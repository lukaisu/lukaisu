...
import {
  ...
  getStatusAbbr,
  createWordTooltip,
} from '../../webapp/js/modules/vocabulary/services/word_status';
import {
  getLangFromDict,
  createTheDictUrl,
  createTheDictLink,
  ...
  openDictionaryPopup,
} from '../../webapp/js/modules/vocabulary/services/dictionary';
import {
  escapeHtml,
  escapeHtmlWithAnnotation,
  escapeApostrophes,
} from '../../webapp/js/shared/utils/html_utils';
import {
  getCookie,
  setCookie,
  deleteCookie,
  areCookiesEnabled,
} from '../../webapp/js/shared/utils/cookies';
import {
  validateTablePrefix,
} from '../../webapp/js/modules/language/stores/language_settings';
