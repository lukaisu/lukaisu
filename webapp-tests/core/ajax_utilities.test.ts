...
} from '../../webapp/js/shared/utils/ajax_utilities';

// Mock the SettingsApi module
vi.mock('../../webapp/js/modules/admin/api/settings_api', () => ({
  SettingsApi: {
    save: vi.fn().mockResolvedValue({ ok: true, data: {} })
  }
}));

import { SettingsApi } from '../../webapp/js/modules/admin/api/settings_api';
