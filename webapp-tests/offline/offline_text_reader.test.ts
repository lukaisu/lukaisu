...
vi.mock('../../webapp/js/shared/offline/text-service', () => ({
...
vi.mock('../../webapp/js/modules/text/api/texts_api', () => ({
  TextsApi: {
    getWords: vi.fn().mockResolvedValue({ data: null, error: 'Not found' }),
  },
}));

vi.mock('../../webapp/js/shared/offline/db', () => ({
  offlineDb: {
    texts: {
...
import {
  ...
  type TextDataResult,
} from '../../webapp/js/shared/offline/offline-text-reader';
import {
  isOfflineStorageAvailable,
  isTextAvailableOffline,
  getOfflineTextData,
} from '../../webapp/js/shared/offline/text-service';
import { TextsApi } from '../../webapp/js/modules/text/api/texts_api';
import { offlineDb } from '../../webapp/js/shared/offline/db';
