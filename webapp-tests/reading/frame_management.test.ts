...
import {
  ...
  successSound,
  failureSound
} from '../../webapp/js/modules/text/pages/reading/frame_management';

// Mock word_popup module
vi.mock('../../webapp/js/modules/vocabulary/components/word_popup', () => ({
  closePopup: vi.fn(),
  closeParentPopup: vi.fn()
}));

import { closeParentPopup } from '../../webapp/js/modules/vocabulary/components/word_popup';
